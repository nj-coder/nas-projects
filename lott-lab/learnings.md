...
Generated: 2026-09-11T01:20:04.606504+00:00
...
- Verified draws retained: 200 (2026-02-23 to 2026-09-10).
- Full-history positive deviations: 35 (39 observed; 31.818 expected), 1 (38 observed; 31.818 expected), 27 (38 observed; 31.818 expected), 30 (38 observed; 31.818 expected), 2 (37 observed; 31.818 expected), 3 (37 observed; 31.818 expected), 14 (37 observed; 31.818 expected), 15 (37 observed; 31.818 expected).
- Latest 20 draws positive deviations: 1 (6 observed; 3.182 expected), 2 (6 observed; 3.182 expected), 5 (6 observed; 3.182 expected), 12 (6 observed; 3.182 expected), 17 (6 observed; 3.182 expected), 34 (6 observed; 3.182 expected), 9 (5 observed; 3.182 expected), 27 (5 observed; 3.182 expected).
- Largest recent upward occurrence shifts: 17 (1 in the previous window to 6 in the latest window), 16 (0 in the previous window to 4 in the latest window), 42 (1 in the previous window to 5 in the latest window), 33 (2 in the previous window to 5 in the latest window), 34 (3 in the previous window to 6 in the latest window), 1 (4 in the previous window to 6 in the latest window), 5 (4 in the previous window to 6 in the latest window), 10 (1 in the previous window to 3 in the latest window).
- Live selected-vs-control evidence: weakened; 46 draws; mean match delta -1.32609; recommended weight 0.15.
- Walk-forward evidence: weakened; 60 folds; mean match delta -0.00313; recommended weight 0.15.
...
- Verified draws retained: 156 (2025-09-12 to 2026-09-09).
- Full-history positive deviations: 11 (33 observed; 20.8 expected), 26 (32 observed; 20.8 expected), 22 (31 observed; 20.8 expected), 36 (29 observed; 20.8 expected), 13 (27 observed; 20.8 expected), 43 (27 observed; 20.8 expected), 17 (26 observed; 20.8 expected), 15 (25 observed; 20.8 expected).
- Latest 20 draws positive deviations: 42 (6 observed; 2.667 expected), 43 (6 observed; 2.667 expected), 11 (5 observed; 2.667 expected), 22 (5 observed; 2.667 expected), 32 (5 observed; 2.667 expected), 45 (5 observed; 2.667 expected), 17 (4 observed; 2.667 expected), 24 (4 observed; 2.667 expected).
- Largest recent upward occurrence shifts: 42 (1 in the previous window to 6 in the latest window), 32 (1 in the previous window to 5 in the latest window), 43 (2 in the previous window to 6 in the latest window), 45 (2 in the previous window to 5 in the latest window), 9 (1 in the previous window to 3 in the latest window), 18 (1 in the previous window to 3 in the latest window), 27 (0 in the previous window to 2 in the latest window), 4 (0 in the previous window to 1 in the latest window).
...
- Verified draws retained: 52 (2025-09-13 to 2026-09-05).
- Full-history positive deviations: 33 (13 observed; 6.933 expected), 13 (11 observed; 6.933 expected), 17 (11 observed; 6.933 expected), 3 (10 observed; 6.933 expected), 8 (10 observed; 6.933 expected), 10 (9 observed; 6.933 expected), 14 (9 observed; 6.933 expected), 28 (9 observed; 6.933 expected).
- Latest 20 draws positive deviations: 17 (6 observed; 2.667 expected), 11 (5 observed; 2.667 expected), 12 (5 observed; 2.667 expected), 33 (5 observed; 2.667 expected), 43 (5 observed; 2.667 expected), 2 (4 observed; 2.667 expected), 3 (4 observed; 2.667 expected), 13 (4 observed; 2.667 expected).
- Largest recent upward occurrence shifts: 12 (1 in the previous window to 5 in the latest window), 17 (3 in the previous window to 6 in the latest window), 2 (2 in the previous window to 4 in the latest window), 11 (3 in the previous window to 5 in the latest window), 15 (1 in the previous window to 3 in the latest window), 31 (2 in the previous window to 4 in the latest window), 43 (3 in the previous window to 5 in the latest window), 6 (2 in the previous window to 3 in the latest window).
...
<!-- LOTT_LAB_LEARNING_JSON
{
  ...
  "format_version": 1,
  "generated_at": "2026-09-11T01:20:04.606504+00:00",
  ...
  "products": {
    "MondayWednesdayFridayLotto": {
      ...
      "frequency": {
        ...
        "draw_count": 156,
        "expected_count_per_number": 20.8,
        "history_end": "2026-09-09",
    ...
    "SetForLife": {
      ...
      "performance": {
        ...
        "live_control": {
          ...
          "control_matches": 3389,
          "evaluated_draws": 46,
          "evaluated_lines": 3010,
          "interval_method": "deterministic-paired-bootstrap-percentile",
          "mean_match_delta": -1.32609,
          "model_weight": 0.15,
          "reason": "historical weighting trails controls but the result is not conclusive",
          "sample_count": 46,
          "selected_matches": 3328,
          "standard_error": 0.92942,
          "status": "weakened"
        },
    ...
    "TattsLotto": {
      ...
      "frequency": {
        "descriptive_only": "Occurrences and shifts describe retained verified draws; they do not change the mathematical probability of an independent future draw.",
        "draw_count": 52,
        "expected_count_per_number": 6.933,
  ...
  "snapshot_hash": "1455b8963ddce047529d09e76129e79841daf9e9e64555a54c6c6de3dc6653ce"
}
LOTT_LAB_LEARNING_JSON -->
